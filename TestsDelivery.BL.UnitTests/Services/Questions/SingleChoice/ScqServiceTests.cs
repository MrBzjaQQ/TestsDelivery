...
namespace TestsDelivery.BL.UnitTests.Services.Questions.SingleChoice
{
    public class ScqServiceTests
    {
        ...
        private readonly ScqService _service;

        public ScqServiceTests()
        {
            ...
            _service = new ScqService(_questionRepositoryMock.Object, _answerOptionsRepoMock.Object, _mapper);
        }
        ...
        public void CreateQuestion_DependenciesCalled()
        {
            ...
            var inputQuestion = new SingleChoiceQuestion()
            {
                Name = "Name",
                Text = "Test",
        ...
        public void DeleteQuestion_DependenciesCalled()
        {
            ...
            _questionRepositoryMock.Verify(x => x.DeleteQuestion(questionId, (short)QuestionType.SingleChoice), Times.Once);
        }
